...
class InboxScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        backgroundColor: Colors.lightBlue[50], // 🌟 added
        appBar: AppBar(
...
class _ProfilePageState extends State<ProfilePage> {
  ...
  void initState() {
    ...
    emailController.text = user?.email ?? "tony@gmail.com";
  }
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () {
            // Navigate to SearchPage on back
            Navigator.push(
              context,
          ...
          child: Column(
            children: [
              ...
              TextFormField(
                ...
                decoration: _inputDecoration('Car Number'),
              ...
              TextFormField(
                ...
                decoration: _inputDecoration('Price per Seat'),
                keyboardType: TextInputType.number,
              ...
              TextFormField(
                controller: dateController,
                decoration: _inputDecoration('Date (e.g., 25 June 2025)'),
                validator: (value) => value!.isEmpty ? 'Enter date' : null,
              ),
              const SizedBox(height: 12),
              TextFormField(
                controller: timeController,
                decoration: _inputDecoration('Time (e.g., 5:00 PM)'),
